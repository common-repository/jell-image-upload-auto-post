 ...
 * define constants
 */
define('XHR_PLUGIN_NAME', 'jell-image-upload-auto-post');
define('XHR_PLUGIN_SITE', get_option( 'siteurl' ));
...
function jell_image_upload_auto_post_options_page() {
    ...
    <p>
        <strong>{title}</strong> - The Image file name text.<br>
        <strong>{site-name}</strong> - site / blog name.<br>
        <strong>{seo-title}</strong> - The Title for meta tage title WordPress SEO by Yoast plugin for the post<br>
        <strong>{seo-description}</strong> -  The description of meta tag description WordPress SEO by Yoast plugin for the post<br>
        <strong>{seo-keyword}</strong> - Inserts the "Focus Keyword" as set in the WordPress SEO by Yoast plugin for the post.<br>	
        <strong>{link}</strong> - Link to the image <br>
        <strong>{src}</strong> - The image file in the specified size<br>
        <strong>{image-alt}</strong> - The image alt tag text<br>
        <strong>{width}</strong> - The image width<br>
        <strong>{height}</strong> - The image height<br>
        <strong>{media}</strong> - The image media type<br>
        <strong>{cat}</strong> - The image Category<br>
        <strong>{tags}</strong> - The image Category<br>
    </p>
    <div class="clear"></div>
    <?php
}
